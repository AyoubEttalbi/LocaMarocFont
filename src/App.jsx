      ...
      <Router>
        <div className="car-rental-app">
          <Routes>
            ...
            {/* Protected routes */}
            <Route path="/rent-now" element={<ProtectedRoute><RentNow /></ProtectedRoute>} />
            <Route path="/profile" element={<ProtectedRoute><Profile /></ProtectedRoute>} />
            <Route path="/cars/:id/reserve" element={<ProtectedRoute><CarReservation /></ProtectedRoute>} />
            ...
            <Route path="/admin/cars" element={<ProtectedRoute><AdminRoute><CarManagement /></AdminRoute></ProtectedRoute>} />
            <Route path="/admin/reservations" element={<ProtectedRoute><AdminRoute><ReservationManagement /></AdminRoute></ProtectedRoute>} />
            <Route path="/admin/users" element={<ProtectedRoute><AdminRoute><UsersManagement /></AdminRoute></ProtectedRoute>} />
            <Route path="/admin/accessories" element={<ProtectedRoute><AdminRoute><AccessoriesManagement /></AdminRoute></ProtectedRoute>} />
            <Route path="/admin/reports" element={<ProtectedRoute><AdminRoute><Reports /></AdminRoute></ProtectedRoute>} />
            <Route path="/admin/settings" element={<ProtectedRoute><AdminRoute><Settings /></AdminRoute></ProtectedRoute>} />
          </Routes>
        </div>
      </Router>
    </AuthProvider>
